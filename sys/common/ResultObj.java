...
public class ResultObj {
    ...
    public static final ResultObj INGOODS_SUCCESS = new ResultObj(Constast.OK, "入库成功");
    public static final ResultObj INGOODS_ERROR = new ResultObj(Constast.ERROR,"入库失败");

    public static final ResultObj OUTGOODS_SUCCESS =new ResultObj(Constast.OK,"出库成功");
    public  static final ResultObj OUTGOODS_ERROR =new ResultObj(Constast.ERROR,"出库失败");
